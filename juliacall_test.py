...
jl.include("src/GLNS.jl")

args_jl = juliacall.convert(jl.Array[jl.String, 1], ["/home/noopygbhat/GLKH-1.1/GTSPLIB/debug/custom0.gtsp", "-output=custom.tour", "-lazy_edge_eval=0", "-verbose=3", "-mode=fast"])
...
time_limit = 10.
inf_val = 9999
given_initial_tours_jl = juliacall.convert(jl.Array[jl.Int64, 1], given_initial_tours)
do_perf = False
perf_file = ""

dist = np.load("/home/noopygbhat/GLKH-1.1/GTSPLIB/debug/custom0.npy")
dist_jl = juliacall.convert(jl.Array[jl.Int64, 2], dist)

jl.GLNS.main(args_jl, time_limit, inf_val, given_initial_tours_jl, do_perf, perf_file, dist_jl)
